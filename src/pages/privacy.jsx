    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 py-8 px-4 md:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-6 md:p-10">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          This privacy policy applies to the Salsivo app (hereby referred to as
          "Application") for mobile devices that was created by Salsivo (hereby
          referred to as "Service Provider") as a Freemium service. This service
        ...
        <ul className="list-disc list-inside space-y-3 mb-6 ml-4 text-gray-700">
          <li>
            <strong className="text-gray-900">Geolocation Services:</strong> The
            Service Provider utilizes location data to provide features such as
          ...
          <li>
            ...
            Periodically, the Service Provider may transmit anonymized location
            data to external services. These services assist them in enhancing
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          ...
          identifiable information, including but not limited to Email, User ID,
          Phone Number. The information that the Service Provider request will
        ...
        <p className="text-gray-600 italic mb-6 bg-gray-50 p-3 rounded border-l-4 border-blue-500">
          This privacy policy is effective as of 2025-10-23
        </p>
